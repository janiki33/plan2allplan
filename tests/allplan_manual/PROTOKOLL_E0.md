...
**Voraussetzungen**
- Repo lokal geklont (z. B. `git clone https://github.com/janiki33/plan2allplan`), Branch `main`
  (solange die Arbeit noch auf `claude/plan2allplan-bim-automation-0hcz95` liegt: `-Branch 'claude/plan2allplan-bim-automation-0hcz95'` anhängen).
...
| 2 | Dateien prüfen: `<AllplanUsr>\Library\Plan2Allplan\Plan2Allplan.pyp` und `<AllplanUsr>\PythonPartsScripts\Plan2Allplan\{__init__.py, dummy.py}` | Alle drei Dateien vorhanden. | |
